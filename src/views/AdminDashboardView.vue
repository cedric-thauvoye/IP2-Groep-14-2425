      ...
      <div v-if="activeTab === 'courses'" class="admin-section">
        <div class="section-header">
          ...
          <div class="controls">
            ...
            <button class="add-button" @click="showCourseModal = true">
      ...
      <div v-if="activeTab === 'groups'" class="admin-section">
        <div class="section-header">
          ...
          <div class="controls">
            ...
            <button class="add-button" @click="showGroupModal = true">
      ...
      <div v-if="activeTab === 'users'" class="admin-section">
        <div class="section-header">
          ...
          <div class="controls">
            ...
            <button class="add-button" @click="showUserModal = true">
          ...
          <div class="modal-body">
            <form @submit.prevent="saveEditedGroup">
              ...
              <div class="form-group">
                ...
                <select
                  id="group-course"
                  v-model="editingGroup.course_id"
                >
                  <option v-for="course in courses" :key="course.id" :value="course.id">
                    {{ course.name }}
                  </option>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="saveEditedUser">
              ...
              <div class="form-actions">
                <button type="button" class="cancel-button" @click="showEditUserModal = false">
                  Cancel
                </button>
                <button type="submit" class="save-button">
                  Save Changes
...
const filterGroups = () => {
  ...
  filteredGroups.value = groups.value.filter(group => {
    const matchesSearch = group.name.toLowerCase().includes(searchTerm) ||
                         group.course_name.toLowerCase().includes(searchTerm);
...
.activity-icon.user i { color: #3498db; }
.activity-icon.course i { color: #2ecc71; }
.activity-icon.group i { color: #f39c12; }
.activity-icon.assessment i { color: #9b59b6; }
